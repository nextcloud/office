OC.L10N.register(
    ...
    "Blank" : "Eidel",
    "Search {category}" : "Sich {category}",
    "Search" : "Sichen",
    "Starred {category}" : "Favoriséiert {category}",
    ...
    "No {category} found" : "Kee(n) {category} fonnt",
    "Switch to \"All\" to see every file you have access to" : "Wiesselen op „All“, fir all Fichieren ze weisen, op déi s du Zougreff hues.",
    "Search all in Files" : "An alle Fichiere sichen",
    "Show all in Files" : "All Fichiere weisen",
    "Create" : "Erstellen",
